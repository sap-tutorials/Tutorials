...
exports.default = {
  getBlock: function getBlock(src, index, length) {
    ...
    if (lineInfo.column > 28) {
      lineStart = lineInfo.column - 28;
    }
    if (lineEnd - (lineInfo.column + length) > 28) {
      lineEnd = lineInfo.column + length + 28;
    }
    var info = _chalk2.default.red(lineInfo.line.substring(lineStart, lineInfo.column)) + _chalk2.default.cyan(lineInfo.line.substr(lineInfo.column, length)) + _chalk2.default.red(lineInfo.line.substring(lineInfo.column + length, lineEnd));
    return {
      info: info,
