---
title: Test the "Clustering" service
description: Using a REST client, you will test the "Clustering" SAP Cloud Platform predictive service
...
## Details
### You will learn  
- How to use the "Clustering" SAP Cloud for predictive services from a REST Client.
...
[ACCORDION-BEGIN [Info:](A short description of the Clustering service)]
The Clustering service analyzes entities provided in a dataset to identify homogeneous groups. The algorithm can run in a supervised or unsupervised way.

For the supervised way, you will provide a binary target column that will be used to define the members of each clusters.

This service:

 - Identifies a set of clusters with homogeneous members the variables with an influence on a specified target ordered by decreasing contribution
