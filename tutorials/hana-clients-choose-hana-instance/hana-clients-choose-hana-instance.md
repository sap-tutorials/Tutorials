...
4. Opening a SQL console in SAP HANA database explorer will display the current schema as DBADMIN.  A schema is a container for other database objects such as tables and views.
