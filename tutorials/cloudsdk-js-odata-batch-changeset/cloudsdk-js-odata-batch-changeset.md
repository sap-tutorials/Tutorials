...
In the previous [tutorials](https://developers.sap.com/group.cloudsdk-js-vdm.html), you learned how to leverage the SAP Cloud SDK to build queries for [basic OData operations](https://www.odata.org/getting-started/basic-tutorial/). The basic OData operations allow you to
