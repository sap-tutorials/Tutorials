...
1. **Add a `read` function in the `HCPms` class**
...
2. **Add identifier to table cell**
...
3. **Add a variable `tableData` that will hold the table data**
...
4. **Link the `tableData` array to the `TableView`**
...
5. **Implement function `loadData` in `TableViewController`**
