...
description: Get access to the Document Information Extraction Trial UI using a booster in SAP BTP Trial that automatically creates a service instance, and subscribes you to the UI application for Document Information Extraction.
