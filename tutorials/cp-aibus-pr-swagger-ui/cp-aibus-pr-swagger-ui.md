...
4. Enter site name (`pr_tutorial_site`) and tenant name (`pr_tutorial`). Click **Execute**.
    ...
    ![PRS](Similar-item-inference.png)

    You should receive a response like the following:

    ![PRS](Similar-item-inference-response.png)
...
4. Enter site name (`pr_tutorial_site`) and tenant name (`pr_tutorial`). Click **Execute**.
    ...
    ![PRS](Smart-search-inference.png)

    You should receive a response like the following:

    ![PRS](Smart-search-inference-response.png)
...
4. Enter site name (`pr_tutorial_site`) and tenant name (`pr_tutorial`). Click **Execute**.
    ...
    ![PRS](User-affinity-inference.png)

    You should receive a response like the following:

    ![PRS](User-affinity-inference-response.png)
...
3. Enter tenant name (`pr_tutorial`) and site name (`pr_tutorial_site`). Click **Execute**.
    ...
    ![PRS](Delete-serving.png)

    You should receive a response like the following:

    ![PRS](Delete-serving-response.png)
...
4. Set `all_sites` to `true` and click **Execute**.
    ...
    ![PRS](Delete-resource.png)

    You should receive a response like the following:

    ![PRS](Delete-resource-response.png)
