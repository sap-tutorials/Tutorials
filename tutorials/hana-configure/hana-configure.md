...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/4.png)
...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/5.png)

Add the SAP HANA Development perspective. This is the perspective you should be using for almost this entire walkthrough:

![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/6.png)

Repeat the step and add the Debug perspective:

![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/7.png)
...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/8.png)
...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/9.png)

Click on the ```Systems``` view.  Right click in the white space below this tab and choose ```Add System...```.

![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/10.png)
...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/11.png)
...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/12.png)
...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/13.png)
...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/14.png)

Confirm the file system location on your local machine which will hold the local copy of this Workspace. Click ```Finish```:

![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/15.png)

You should now see the local workspace mapped to the remote workspace in the SAP HANA Repositories view:

![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/16.png)
...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/18.png)
...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/19.png)
...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/20.png)

The Web Workbench also has some project wizards.  Right mouse click on the exercises folder and choose ```Create Application```:

![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/21.png)
...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/22.png)
...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/23.png)
...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/24.png)

We will also need a schema to house database catalog objects. Right mouse on your group package and choose ```New->File```:

![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/25.png)
...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/26.png)

A code template can be inserted into the new development object by choosing the Insert snippet button from the toolbar:

![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/27.png)
...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/28.png)

Save the Schema:

![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/29.png)
...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/30.png)

Expand the Users folder and then select your user:

![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/31.png)

In the user details, select the Object Privileges tab and then press ```Add```:

![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/32.png)

Search for ```HANA_WORKSHOP_``` and then select the Schema name you created in the earlier step (```HANA_WORKSHOP_01```):

![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/33.png)
...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/34.png)

Save your changes:

![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/35.png)

You can now close the Security tab in the browser and return to the Editor tab:

![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/36.png)
...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/37.png)

Select the ```index.html``` file and then press the ```Run``` button in order to test it:

![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/38.png)
...
![](https://raw.githubusercontent.com/SAPDocuments/Tutorials/master/hana-configure/39.png)
