...
This section goes beyond the pure build and point out how to add a post-build step to deploy the application to SAP Cloud Platform.
...
##### Enhance the `pom.xml` file to install the SAP Cloud Platform SDK automatically during the build step.
...
3. Open Travis CI and go to your project. Select **More options > Settings** and add the values below. You must switch off **Display value in build log** to avoid making your settings public.
    ...
    Field                | Value                               
    :------------------- |:------------------------------------
    `SAP_CLOUD_USERNAME` | {The user name of your SAP Cloud Platform account}
    `SAP_CLOUD_ACCOUNT`  | {The name of your SAP Cloud Platform account}
