...
## Prerequisites
- You've access to the SAP Business Application Studio in a trial account on SAP Cloud Platform, see [Set Up SAP Business Application Studio for Development](appstudio-onboarding)
- You've created a Full Stack Cloud Application dev space in the Business Application Studio.
...
!![Link text e.g., Destination screen](graph-modeler-4.png)
...
1. Select *Books* and see that the newly changed model and its sample data is served as part of your `CatalogService` service.
    ...
    !![Link text e.g., Destination screen](app-books-with-sample.png)
