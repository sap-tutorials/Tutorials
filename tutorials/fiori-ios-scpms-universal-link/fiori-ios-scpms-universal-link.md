...
### Setup Your App for Universal Links
...
<!-- border -->![Xcode](fiori-ios-scpms-universal-link-01.png)
...
<!-- border -->![Xcode](fiori-ios-scpms-universal-link-02.png)
...
<!-- border -->![Apple Developer Portal](fiori-ios-scpms-universal-link-03.png)

Click the **Plus** button next to **Identifiers** to register an App ID.

<!-- border -->![Apple Developer Portal](fiori-ios-scpms-universal-link-04.png)

Make sure that **App IDs** is selected and click on **Continue**.

<!-- border -->![Apple Developer Portal](fiori-ios-scpms-universal-link-05.png)
...
<!-- border -->![Apple Developer Portal](fiori-ios-scpms-universal-link-06.png)
...
<!-- border -->![Define application link](fiori-ios-scpms-universal-link-07.png)
...
<!-- border -->![Define application link](fiori-ios-scpms-universal-link-08.png)
...
<!-- border -->![Define application link](fiori-ios-scpms-universal-link-09.png)

Confirm the dialog to see your application links.

<!-- border -->![Define application link](fiori-ios-scpms-universal-link-10.png)

Navigate back to the **APIs** tab. You should see two QR codes, as well as the generated links:

<!-- border -->![Define application link](fiori-ios-scpms-universal-link-11.png)
...
<!-- border -->![Define application link](fiori-ios-scpms-universal-link-13.png)
...
<!-- border -->![Define application link](fiori-ios-scpms-universal-link-14.png)
...
<!-- border -->![Define application link](fiori-ios-scpms-universal-link-15.png)
...
<!-- border -->![Build and deploy the app](fiori-ios-scpms-universal-link-12.png)
...
<!-- border -->![Try the universal link](fiori-ios-scpms-universal-link-11.png)
...
<!-- border -->![Try the universal link](fiori-ios-scpms-universal-link-16.png)
