...
### Copy UI.FieldGroup from backend annotation source
...
### Add section with UI.Facets to display technical data
...
### Add section to show monthly revenue of product
...
### Add UI.LineItem to configure sales history table
...
### Add section to show sales data of a product
...
### Add header and section to show sales data details
