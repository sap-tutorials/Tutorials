...
5. **Launch the application to see what happens**
...
6. **Create custom `UITableViewController`**
...
7. **Link the `UITableViewController` to the Table View**
...
9. **Launch the application check whether the login screen appears**
...
10. **Implement the Login view logic**
...
11. **Launch the application check whether the login flow logic works**
...
12. **Registration URL composition**
...
13. **Determining registration payload**
...
14. **Define the variables that hold the user ID and password**
...
16. **Implement register function**
...
17. **Test the registration routines**
