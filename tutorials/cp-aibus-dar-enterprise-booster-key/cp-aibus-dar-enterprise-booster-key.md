---
title: Use the Free Tier Service Plan to Set Up Account for Data Attribute Recommendation and Get Service Key
description: Use an SAP BTP booster to automatically create a service instance, and the associated service key for Data Attribute Recommendation.
...
- You are entitled to use the service: [Manage Entitlements Using the Cockpit](btp-cockpit-entitlements).
...
6. Choose the **free** plan. You can also rename the subaccount to `free-tier-service-plan-tutorial`, for example. Click **Next**.
...
8. Follow the progress of the booster automated tasks before being able to see the **Success** dialog box.
...
>If you face any issue with the booster **Set up account for Data Attribute Recommendation**, you can alternatively follow the steps in [Set Up a BTP Account for Tutorials](group.btp-setup) to create the service instance and service key for Data Attribute Recommendation manually using the free plan.
