...
description: Create a service instance and the associated service key for Invoice Object Recommendation, one of the SAP AI Business Services, using the SAP Cloud Platform trial cockpit.
