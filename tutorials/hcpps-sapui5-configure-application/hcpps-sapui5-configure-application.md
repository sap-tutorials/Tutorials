...
> **Note: The '`xxxxx`' represent the current application namespace that was generated by the template wizard. Take a note of that value as we will need to replace it in the next tutorials**
...
> **Note: The '`xxxxx`' represent the current application namespace that was generated by the template wizard. Make sure you are keeping its original value**
