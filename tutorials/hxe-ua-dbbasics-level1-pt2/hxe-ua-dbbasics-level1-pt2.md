---
title: Database Basics Level 1 Part II - Packages and Connecting, Editing, and Previewing Data
description: For this tutorial series, you will load data on to your SAP HANA 2.0, express edition installation and preview that data. This second tutorial will teach you how to create a new package, load and connect data to that package, and then edit and preview that data.
tags: [  tutorial>beginner, products>sap-hana\,-express-edition ]
---

## Prerequisites  
 - **Tutorials:** [Sample Project Level 1 Part I - User, Schema, and `.csv` Data](https://www.sap.com/developer/tutorials/hxe-ua-dbbasics-level1-pt1.html)
...
## Details
### You will learn  
How to create a package, load data to that package, and preview that data.
...
[ACCORDION-BEGIN [Step 1: ](Create a New Package)]
...
[ACCORDION-BEGIN [Step 2: ](Load and Connect Data)]
...
[ACCORDION-BEGIN [Step 3: ](Edit Semantics)]
...
[ACCORDION-BEGIN [Step 4: ](Preview Data)]
