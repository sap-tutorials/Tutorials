...
<!-- border -->![MobileCards](img_1_1.png)


### Go to SAP Mobile Services cockpit
...
3. Navigate to the trial global account by clicking **Go To Your Trial Account**.
    ...
    <!-- border -->![Enter Global Account](img_2_3.png)
...
4. Navigate to your subaccount by clicking on the tile named **trial**.
    ...
    <!-- border -->![Trial Global Account](img_2_4.png)

5. Under **Spaces**, choose the available space as highlighted below.

    <!-- border -->![Enter Space](img_2_5.png)
...
6. In the left pane, choose **Services** > **Service Marketplace**.
    ...
    <!-- border -->![Enter Service Marketplace](img_2_6.png)
...
1. Launch Mobile Cards Application on your device.
    ...
    <!-- border -->![App Launch](img_4_and_1.png)
...
10. Tap **Allow only while using the app** option for the location services request.
    ...
    <!-- border -->![Location Services Screen](img_4_and_10.png)
...
3. Enter your **SAP BTP login credentials** and tap **Log On**.
    ...
    <!-- border -->![SAP BTP Login screen](img_4_ios_3.png)

4. Define a passcode to unlock the app and tap **Done**.

    <!-- border -->![Passcode Screen](img_4_ios_4.png)

5. Tap **Enable** to enable biometric authentication.

    <!-- border -->![Biometric Screen](img_4_ios_5.png)
...
6. Tap **Allow** to enable notification functionality for your application.
    ...
    <!-- border -->![Notification Request Screen](img_4_ios_6.png)
