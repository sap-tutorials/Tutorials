...
[ACCORDION-BEGIN [Step 1: ](Check or create your SAP HANA MDC instance in SAP Cloud Platform)]
...
You can find the SQL statements at the following link [`pal_abc_data.txt`](pal_abc_data.txt).
