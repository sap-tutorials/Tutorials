...
## Prerequisites
 - **Tutorials:** [Information View Conversion](https://www.sap.com/) and [Create Tables and Import Data](https://www.sap.com/developer/tutorials/dt-create-schema-load-data-part3.html)

## Next Steps
## Next Steps
 - **Tutorials** [Adding Our Union Calculation View into the Converted Data Model](http://www.sap.com/)
