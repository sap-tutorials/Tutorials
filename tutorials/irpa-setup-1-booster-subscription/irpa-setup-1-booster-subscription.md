...
Refer to the tutorial on [How to create a BTP Free tier account and subscribe to SAP Process Automation](https://developers.sap.com/tutorials/spa-subscribe-booster.html).
