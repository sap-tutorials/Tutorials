---
title: SAP Cloud Platform predictive services, Use the asynchronous Forecast HCP predictive service from a SAPUI5 application
...
## Prerequisites
  ...
  - **Tutorials:** [Use the synchronous Forecast HCP predictive service from a SAPUI5 application](http://www.sap.com/developer/tutorials/hcpps-sapui5-ps-forecast-synchronous.html)
...
1. Create a new file called `ForecastAsynchronous.view.xml` in the `hcppredictiveservicesdemo\webapp\view\forecast` and add the following content.
    ...
    <mvc:View controllerName="demo.controller.forecast.ForecastAsynchronous" xmlns:html="http://www.w3.org/1999/xhtml"
      ...
      <Panel expandable="true" expanded="false" headerText="Forecast with the SAP Cloud Platform predictive services (Asynchronous)"
