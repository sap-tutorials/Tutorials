---
title: SAP Cloud Platform predictive services, Manage your "Data Set" in the HCP predictive service from a SAPUI5 application
...
1. Create a new file called `DatasetManage.view.xml` in the `hcppredictiveservicesdemo\webapp\view\dataset` and add the following content.
    ...
    <mvc:View controllerName="demo.controller.dataset.DatasetManage"
      ...
      <Panel expandable="true" expanded="false" headerText="Manage your Data Set with the SAP Cloud Platform predictive services" class="sapUiResponsiveMargin"
        width="auto">
