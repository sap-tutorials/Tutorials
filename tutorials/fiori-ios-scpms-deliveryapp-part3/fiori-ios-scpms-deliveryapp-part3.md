...
Examine the OData service's metadata, which can be accessed via `https://sapdevsdd27584c4.us2.hana.ondemand.com/codejam/wwdc/services/DeliveryService.xsodata/$metadata` and which you have downloaded locally in the previous tutorial:
...
[ACCORDION-BEGIN [Step 5: ](Implement Table View Cell for Packages)]
...
[ACCORDION-BEGIN [Step 6: ](Implement navigation logic)]
