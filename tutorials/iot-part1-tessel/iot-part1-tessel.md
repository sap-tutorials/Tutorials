...
## Details
### You will learn  
In this tutorial, you will connect and configure your Tessel 1 device (further referenced as simply `Tessel` device).
...
3. Once your Tessel has been connected and you’ve checked to ensure the firmware is up to date you can run other commands such as:
    ...
    `tessel version --board`, which will tell you the version of your Tessel device which can be important depending on the project you have in mind.

    `tessel update --force` will update the Tessel's firmware to the latest version.
