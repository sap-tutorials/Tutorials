...
In order to execute this test you can either create a new html page which executes the tests or you can use [karma](https://karma-runner.github.io/latest/index.html). We will use karma to be able to run the test from the command line. To run karma you have to install `nodejs` and create a `package.json` in the root of your project.
...
[ACCORDION-BEGIN [Step 7: ](Troubleshoot and Questions)]
