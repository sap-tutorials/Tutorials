...
description: Active the pre-delivered kanban template in your SAP Internet of Things tenant which will create the Business Context, Business Context Hierarchy and Auto-ID Event Enrichment objects for you automatically.
...
[ACCORDION-BEGIN [Step 2: ](Active the kanban Business Template)]
...
[ACCORDION-BEGIN [Step 3: ](Review the result of the Template activation)]
