...
description: This tutorial shows you how to deploy a simple Multitarget Application (MTA) to SAP Business Technology Platform, Cloud Foundry environment using the MultiApps CF CLI Plugin. The example MTA demonstrates the creation of a service instance and an application, and the binding between them.
...
---
**Note:** The example above shows the deployment from a directory where the MTA deployment descriptor is available.
...
[ACCORDION-BEGIN [Step 5: ](Examine the result of the MTA deployment)]
...
[ACCORDION-BEGIN [Step 8: ](Examine the result of the MTA and the extension descriptor deployment)]
