...
<!-- description --> By taking this tutorial, you'll explore, set up, and manage the sections of your SAP profile (people.sap.com). You'll also earn the Profile Savvy badge in the SAP Community.
...
<!-- border -->![Public Profile](Public_Profile.png)
...
<!-- border -->![Profile Linking](Profile_Linking.png)
...
<!-- border -->![Login Settings](Login_Settings.png)
...
<!-- border -->![Following](Following.png)
...
<!-- border -->![Activity_Log](Activity_Log.png)
...
<!-- border -->![Connections](Connections.png)
