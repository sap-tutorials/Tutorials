...
Destinations are key building blocks in the SAP Cloud Platform Connectivity service, and are used to define connections for outbound communication of your application to remote systems. These remote systems can be on-premises or in the cloud.
