...
<!-- border -->![HXE_SP04_Register_Button_4](HXE_SP04_Register_Button_4.png)

Read and accept the end user license agreement, and then click **Submit**.

<!-- border -->![HXE_EULA_SP04_1](HXE_EULA_SP04_1.png)

The registration form displays.

On the registration form, enter all required information and click **Submit**.

<!-- border -->![HXE_Registration_form_SP04_2](HXE_Registration_form_SP04_2.png)
...
<!-- border -->![HXE_Download_Manager_SP04_3](HXE_Download_Manager_SP04_3.png)
...
### Save the download manager file
