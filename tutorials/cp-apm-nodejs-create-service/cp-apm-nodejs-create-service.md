...
## Prerequisites
- You've installed [Node.js](https://nodejs.org/en/). Use latest long-term support (LTS) version 10 or 12. In case of problems, see the [Troubleshooting guide](https://cap.cloud.sap/docs/resources/troubleshooting#npm-installation) for CAP.
