...
Scenarios refers to an ML use case. It gets automatically created when you upload workflows *(YAML files, see screenshots below)* to your GitHub repository connected with your SAP AI Core.
...
1. `name` refers to the **Executable ID**, an identifier for your workflow. This must be unique for each executable even if they are part of same the scenario.
